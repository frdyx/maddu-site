...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { kind: 'route', title: 'Capabilities',  url: '/capabilities',  group: 'page', keywords: 'capabilities verbs ontology commands 61 cli',                       desc: 'Every verb earns its place — 61 across 8 areas' },
  ...
  { kind: 'sub', title: 'Quality & review',                    url: '/capabilities#quality',       group: 'verbs', targetRoute: 'Capabilities', keywords: 'capabilities quality review test self-test lint format doctor', desc: 'review · test · self-test · lint · format · doctor' },
