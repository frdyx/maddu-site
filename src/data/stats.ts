...
export const VERSION_SHORT = 'v1.96';

/** Capability surface — derived from capabilities-detail.json (regenerated from the framework repo). */
export const VERBS_TOTAL: number = capabilities.total; // 72 at v1.96.0
export const VERBS_WITH_DEEP_DIVE: number = capabilities.withDeepDive; // 60 at v1.96.0
...
export const DOCTOR_GATES = 72; // builtin gate budget, 72/72 at cap (v1.95.0)
export const AUDIT_CHECKS = 16; // maddu audit self-checks
export const EVENT_TYPES = 173; // schematized event types (contract x-contractVersion 1.1.0)
