...
export const VERSION_SHORT = 'v1.97';

/** Capability surface — derived from capabilities-detail.json (regenerated from the framework repo). */
export const VERBS_TOTAL: number = capabilities.total; // 72 at v1.97.0
export const VERBS_WITH_DEEP_DIVE: number = capabilities.withDeepDive; // 60 at v1.97.0
...
/** Enforcement surface — read from the framework repo at v1.97.0. */
export const HARD_RULES = '8 + 1';
export const DOCTOR_GATES = 74; // builtin gate budget, 74/74 at cap (v1.97.0)
export const AUDIT_CHECKS = 16; // maddu audit self-checks
export const EVENT_TYPES = 175; // schematized event types (contract x-contractVersion 1.3.0)
export const CONTRACT_VERSION = '1.3.0'; // event-schema.json x-contractVersion
export const STRESS_SCENARIOS = 15;

/** Surfaces — read from the framework repo at v1.97.0. */
