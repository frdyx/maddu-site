...
const PAGES = [
  {
    slug: 'index',
    eyebrow: 'V1.3 · LOCAL-FIRST · RUNTIME-AGNOSTIC',
    title: ['The orchestration spine', 'that outlives every', 'agent that touches it.'],
    tone: 'accent',
    stats: [
      { label: 'HARD RULES',       value: '8 + 1' },
      { label: 'DOCTOR GATES',     value: '54' },
      { label: 'STRESS SCENARIOS', value: '12' },
  ...
  },
  {
    ...
    title: ['Thirteen layers.', 'One charter.'],
    tone: 'accent-2',
    stats: [
      { label: 'LAYERS',        value: '13' },
      { label: 'INVARIANTS',    value: '8 + 1' },
      { label: 'VERBS',         value: '53' },
  ...
  {
    slug: 'changelog',
    eyebrow: 'CHANGELOG · V0.17.1 → V1.3.0',
    title: ['Nineteen releases.', 'One charter held.'],
    tone: 'accent-2',
    stats: [
      { label: 'RELEASES',         value: '19' },
      { label: 'DOCTOR GATES +',   value: '+36' },
      { label: 'STRESS SCENARIOS +', value: '+12' },
...
const RELEASES = [
  { v: 'v1.3.0', slug: 'v1-3-0', date: '2026-05-28', type: 'feature',   tone: 'accent',   headline: 'Coherence realignment + completeness' },
